            ...
            for entity in self.entity_dict.keys():
                ...
                if self.isFit:
                    if corrupted_head not in self.train_triple:
                        ...
                        r_emb = self.relation_dict[corrupted_head[1]]
                        t_emb = self.entity_dict[corrupted_head[2]]
                ...
                corrupted_tail = [triple[0],triple[1],entity]
                if self.isFit:
                    if corrupted_tail not in self.train_triple:
                        h_emb = self.entity_dict[corrupted_tail[0]]
                        r_emb = self.relation_dict[corrupted_tail[1]]
                        t_emb = self.entity_dict[corrupted_tail[2]]
    ...
    def relation_rank(self):
        ...
        for triple in self.test_triple:
            ...
            for r in self.relation_dict.keys():
                corrupted_relation = (triple[0],triple[2],r)
...
if __name__ == '__main__':
    ...
    test = Test(entity_dict,relation_dict,test_triple,test_triple,isFit=False)
    test.rank()
    print("entity hits@10: ", test.hits10)
    print("entity meanrank: ", test.mean_rank)

    test.relation_rank()
    print("relation hits@1: ", test.relation_hits10)
    ...
    f.write("relation hits@1: " + str(test.relation_hits10) + '\n')
